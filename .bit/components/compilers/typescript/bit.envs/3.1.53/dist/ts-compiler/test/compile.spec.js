...
describe('typescript', () => {
    ...
    after(() => __awaiter(void 0, void 0, void 0, function* () {
        return bit_envs_common_build_component_1.removeWorkspace(results.directory);
    }));
    it('build should pass', () => __awaiter(void 0, void 0, void 0, function* () { }));
    it('build should exclude default ignore patterns', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('should get non compiled files', () => {
        ...
        const nonCompiledFiles = compile_1.getNonCompiledFiles(files, compiledFileTypes);
