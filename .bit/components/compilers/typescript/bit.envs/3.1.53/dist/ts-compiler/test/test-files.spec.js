...
describe('test files', function () {
    ...
    it('should mark as test dist file', function () {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const files = yield bit_bin_1.buildOne('comp', false, false, results.directory);
            process.chdir(cwd);
            chai_1.expect(spy === spy_compiler_1.default.action).to.be.true;
            chai_1.expect(spy.callCount).to.equal(1);
            const returnedTestFile = (yield spy.returnValues[0]).dists.find((elem) => elem.basename === 'test.spec.js');
