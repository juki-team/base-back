...
export declare class TypescriptCompiler implements Compiler {
    ...
    getDynamicConfig(ctx: CompilerContext): import("@bit/bit.envs.common.preset/dist/compiler-types").GenericObject & import("@bit/bit.envs.common.compiler-types").GenericObject;
