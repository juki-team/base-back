...
import { jkLogTelegramBot } from './index';
...
export const TELEGRAM_JUKI_ERRORS_CHAT_ID = process.env.TELEGRAM_JUKI_ERRORS_CHAT_ID || '';

jkLogTelegramBot.config(TELEGRAM_JUKI_LOGS_BOT_TOKEN, TELEGRAM_JUKI_LOGS_CHAT_ID, TELEGRAM_JUKI_ERRORS_CHAT_ID, '__BASE BACK__');
